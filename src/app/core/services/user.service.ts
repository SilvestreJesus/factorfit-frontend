...
export class UserService {
  ...
  getUsuarios(sede: string = ''): Observable<any[]> {
  ...
  // Obtener uno solo
  getUsuariosByClave(clave: string): Observable<any> {
  ...
  // Eliminar
  eliminarUsuarios(clave: string): Observable<any> {
...
subirImagenCloudinary(file: File): Observable<any> {
  ...
  formData.append('folder', 'Usuarios'); // Carpeta específica para Usuarios
